...
execution: inline
agent: vera-veredito
outputFile: squads/barns-western-content/output/review-report.md
on_reject: 4
---
...
- `squads/barns-western-content/output/feed-post.md` — post de Feed do run
- `squads/barns-western-content/output/reel-script.md` — roteiro de Reel do run
- `squads/barns-western-content/output/stories-sequence.md` — sequência de Stories do run
- `squads/barns-western-content/pipeline/data/quality-criteria.md` — critérios de avaliação e regras de veredicto
- `squads/barns-western-content/pipeline/data/tone-of-voice.md` — guia de voz da marca
- `squads/barns-western-content/pipeline/data/anti-patterns.md` — anti-padrões que geram rejeição automática
