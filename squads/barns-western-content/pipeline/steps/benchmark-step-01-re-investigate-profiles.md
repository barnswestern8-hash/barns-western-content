...
outputFile: squads/barns-western-content/output/benchmark-report.md
model_tier: powerful
---
...
- `squads/barns-western-content/pipeline/data/reference-profiles.md` — lista dos 5 perfis, URLs, foco e protocolo de investigação
- `squads/barns-western-content/pipeline/data/output-examples.md` — exemplos da investigação anterior (base para comparação)
- `squads/barns-western-content/pipeline/data/tone-of-voice.md` — padrões de voz da investigação anterior (base para comparação)
