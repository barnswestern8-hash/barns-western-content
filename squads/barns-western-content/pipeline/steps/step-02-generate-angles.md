...
execution: inline
agent: iago-ideia
inputFile: squads/barns-western-content/output/briefing.md
outputFile: squads/barns-western-content/output/angles.md
---
...
- `squads/barns-western-content/output/briefing.md` — briefing do run com produto, tipo de post e mensagem específica
- `squads/barns-western-content/pipeline/data/research-brief.md` — padrões identificados nos 5 perfis investigados
- `squads/barns-western-content/pipeline/data/domain-framework.md` — framework de domínio com posicionamento e vocabulário
