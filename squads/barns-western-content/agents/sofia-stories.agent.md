...
- **Reads from**: `squads/barns-western-content/output/feed-post.md` (obrigatório), `squads/barns-western-content/output/selected-angle.md`, `squads/barns-western-content/pipeline/data/tone-of-voice.md`, `squads/barns-western-content/pipeline/data/image-design.md`
