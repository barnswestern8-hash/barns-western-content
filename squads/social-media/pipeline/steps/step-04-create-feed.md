...
outputFile: squads/social-media/output/feed-post.md
model_tier: powerful
---
...
- `squads/social-media/output/selected-angle.md` — ângulo escolhido com driver, hook, narrativa e tipo de post
- `squads/social-media/output/briefing.md` — produto featured e detalhes do run
- `squads/social-media/pipeline/data/tone-of-voice.md` — guia de voz da marca Barns Western
- `squads/social-media/pipeline/data/output-examples.md` — exemplos de referência de posts aprovados
- `squads/social-media/pipeline/data/anti-patterns.md` — anti-padrões a evitar
