...
agents:
  - id: rodrigo-reels
    ...
    inputFile: squads/social-media/output/selected-angle.md
    outputFile: squads/social-media/output/reel-script.md
  - id: sofia-stories
    format: instagram-stories
    inputFile: squads/social-media/output/feed-post.md
    outputFile: squads/social-media/output/stories-sequence.md
---
...
### Context Loading
- `squads/social-media/output/selected-angle.md` — ângulo com driver, hook e narrativa
- `squads/social-media/output/briefing.md` — produto featured
- `squads/social-media/pipeline/data/tone-of-voice.md` — voz da marca
...
### Context Loading
- `squads/social-media/output/feed-post.md` — post de Feed completo do mesmo run (OBRIGATÓRIO)
- `squads/social-media/output/selected-angle.md` — contexto do ângulo
- `squads/social-media/pipeline/data/tone-of-voice.md` — voz da marca
