---
id: "squads/social-media/agents/iago-ideia"
name: "Iago Ideia"
...
- **Reads from**: `squads/social-media/output/briefing.md` (briefing do usuário)
- **Writes to**: `squads/social-media/output/angles.md` (5 ângulos) e `squads/social-media/output/selected-angle.md` (ângulo escolhido)
