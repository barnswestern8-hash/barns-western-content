---
id: "squads/social-media/agents/bruno-benchmark"
...
- **Reads from**: `squads/social-media/pipeline/data/reference-profiles.md`, `squads/social-media/pipeline/data/output-examples.md`, `squads/social-media/pipeline/data/tone-of-voice.md`
- **Writes to**: `squads/social-media/output/benchmark-report.md` (relatório de mudanças); atualiza `pipeline/data/output-examples.md` e `pipeline/data/tone-of-voice.md`
