---
id: "squads/social-media/agents/fernanda-feed"
name: "Fernanda Feed"
...
- **Reads from**: `squads/social-media/output/selected-angle.md`, `squads/social-media/output/briefing.md`, `squads/social-media/pipeline/data/tone-of-voice.md`, `squads/social-media/pipeline/data/output-examples.md`
- **Writes to**: `squads/social-media/output/feed-post.md`
